\begin{tikzpicture}[node distance=0.5cm and 0.5cm, auto]
	...
	\node (mds0) [aMds, subdiagram, right=4 of u0] {still overloaded};
	\draw[text_small] (mds0) to [out=270, in=0] node [] {load report} (pres);

	\foreach \n in {0,1,2}
	{
		\draw[text_small, font=\ssmall, color=black!50, dashed] (u\n.north east) 
			to [out=0, in=180, looseness=0.8, bend left] node [] {hb} (pres);
	}
