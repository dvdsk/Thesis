\begin{tikzpicture}[node distance=0.5cm and 0.5cm, auto]
	...
	\node (amds) [aMds, right = 1 of pres] {Minister (failing)};
	\node (c1) [cMds, right=of amds] {$\text{Clerk}_{1}$};
	\node (c2) [cMds, right=of c1] {$\text{Clerk}_{2}$};
	\node (cn) [cMds, right=of c2] {$\text{Clerk}_{n}$};
	...
	\node (c1) [cMds, right=2 of pres] {$\text{Clerk}_{1}$};
	\node (c2) [cMds, right=of c1] {$\text{Clerk}_{2}$};
	\node (cn) [cMds, right=of c2] {$\text{Clerk}_{n}$};
	\node at ($(c2.east)!.5!(cn.west)$) {\ldots}; 
	\begin{pgfonlayer}{background}
	...
	\node (amds) [aMds, right=1.7 of pres] {$\text{Minister}$};
	\node (c2) [cMds, right=of amds] {$\text{Clerk}_{2}$};
	\node (cn) [cMds, right=of c2] {$\text{Clerk}_{n}$};
	\node at ($(c2.east)!.5!(cn.west)$) {\ldots}; 
	\begin{pgfonlayer}{background}
		\node [fill=black!8, fit=(amds) (cn)] {};
