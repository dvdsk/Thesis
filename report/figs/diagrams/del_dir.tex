\begin{tikzpicture}[node distance=0.5cm and 1.0cm, auto]
	...
	\node (amds_del1) [aMds, right=of start] {$\text{aMDS}_j$};
	...
	\node (amds1) [aMds, left=0.5 of dots_a] {$\text{aMDS}_1$};
	\node (amds0) [aMds, left=of amds1] {$\text{aMDS}_0$};
	\node (amdsj) [aMds, right=0.5 of dots_a] {$\text{aMDS}_j$};
	\node (amdsn) [aMds, right=of amdsj] {$\text{aMDS}_n$};
	...
	\node (amds1_b) [aMds, left=0.5 of dots_b] {$\text{aMDS}_1$};
	\node (amds0_b) [aMds, left=of amds1_b] {$\text{aMDS}_0$};
	\node (amdsj_b) [aMds, right=0.5 of dots_b] {$\text{aMDS}_j$};
	\node (amdsn_b) [aMds, right=of amdsj_b] {$\text{aMDS}_n-k$};
	\node at ($(amdsj_b)!.5!(amdsn_b)$) {\ldots}; 

	\node (dots_c) [invisible, below= 1 of dots_b] {\ldots};
	\node (amds1_c) [aMds, left=0.5 of dots_c] {$\text{aMDS}_1$};
	\node (amds0_c) [aMds, left=of amds1_c] {$\text{aMDS}_0$};
	\node (amdsj_c) [aMds, right=0.5 of dots_c] {$\text{aMDS}_j$};
	\node (amdsn_c) [aMds, right=of amdsj_c] {$\text{aMDS}_n-k$};
	...
	\node (umdsn_0) [uMds, right=1 of amdsn_c] {$\text{uMDS}_{0}$};
	\node (umdsn_k) [uMds, right= of umdsn_0] {$\text{uMDS}_{k}$};
