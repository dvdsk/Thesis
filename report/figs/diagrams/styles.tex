...
\newcommand{\taskLeg}{\leg{skRed!30}}
\newcommand{\tasksLeg}{\leg{skPurple!30}}
\newcommand{\straightTasksLeg}{\textcolor{skPurple!30}{$\blacksquare$}}
\newcommand{\futureLeg}{\leg{gray!20}}
